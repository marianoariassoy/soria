const Select1 = ({ title }: { title: string }) => {
  return (
    <div className="border-2 border-white rounded-2xl p-4">
      <h3 className="font-extrabold mb-2 px-1">{title}</h3>
      <select className="border-t-2 border-white w-full h-10 flex items-center justify-center px-0 cursor-pointer focus:outline-none hover:text-black">
